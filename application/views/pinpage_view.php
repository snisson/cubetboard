...
<div class="inside_midd_wrap" >
    <div class="inside_left_items_box" id="inside_left_items_box" style="height: auto;">
                             ...
                             <?php else:?>
                                <?php $id_ref =$pinDetails->board_id;?>
                                    ...
                                    <?php if(!isFollow($this->session->userdata('login_user_id'),$pinDetails->board_id)):?>
                                        <a id="follow_btn_<?php echo $id_ref;?>" onclick="follow_unfollow('follow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" style="cursor: pointer;color:#ffffff;"><strong >Follow</strong><span></span></a>
                                    <?php else:?>
                                        <a id="unfollow_btn_<?php echo $id_ref;?>" onclick="follow_unfollow('unfollow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);"  style="cursor: pointer;color:#ffffff;"><strong>Unfollow</strong><span></span></a>
                                    <?php endif?>
                                    </div>

                              <span id="ajax_follow_btn_<?php echo $id_ref;?>" style="display: none;cursor: pointer;color:#ffffff;"><a onclick="follow_unfollow('follow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" ><strong style="color:#ffffff;">Follow</strong><span></span></a></span>
                              <span id="ajax_unfollow_btn_<?php echo $id_ref;?>" style="display: none;cursor: pointer;color:#ffffff;"><a onclick="follow_unfollow('unfollow',<?php echo $id_ref;?>,<?php echo $pinDetails->user_id;?>);" ><strong style="color:#ffffff;">Unfollow</strong><span></span></a></span>
                             <?php endif;?>
                        </span>
                        </span>
                <?php endif;?>
...
<!--                            <li class="edit-button">
            ...
            <div class="insi_pin_bigimage">
                ...
                <img src="<?php echo $pinDetails->pin_url;?>" style="max-width: 500px;"/>
               <?php else:?>
                    ...
                    <ul class="repin_itembox_style">
                        <?php if($repinUsers):?>
                            <?php foreach ($repinUsers as $key => $value): ?>
                                ...
                                <li id="addrepin_<?php echo $value->repin_user_id;?>">
 ...
 $(document).ready(function(){
    ...
    gd = document.getElementById('inside_left_items_box').clientHeight;
    newheight = parseInt(gd) + parseInt(100);
