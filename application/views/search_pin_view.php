                        ...
                        <div class="action">
                            ...
                            <span id="like_action<?php echo $searchResultValue->id; ?>">
                                <?php if ($searchResultValue->user_id == $this->session->userdata('login_user_id')): ?>
                                    <a href="<?php echo site_url('board/pinEdit/' . $searchResultValue->board_id . '/' . $searchResultValue->id) ?>" class="act_repin"><span>Edit</span></a>
                                <?php else: ?>

                                    <?php if (!isLiked($searchResultValue->id, $this->session->userdata('login_user_id'))): ?>
                                        <a class="act_like" id="<?php echo $likeId ?>" href="javascript:;"  onClick="doAction(<?php echo $like; ?>,<?php echo $searchResultValue->id; ?>,'like')"><span>Like</span></a>
                                    <?php else: ?>
                                        <a class="act_unlike" id="<?php echo $unlikeId ?>" href="javascript:;"   onClick="doAction(<?php echo $like; ?>,<?php echo $searchResultValue->id; ?>,'unlike')"><span>UnLike</span></a>
                                    <?php endif ?>
                                <?php endif ?>
                            </span>
                            ...
                            <a class="fancyboxForm act_repin ajax" href="<?php echo site_url('repin/load/' . $searchResultValue->id) ?>/view">Repin</a>
        ...
        <!--                        <a class="act_comment" id="<?php //echo $commentId  ?>" href="javascript:;" onClick="addComment(<?php //echo $searchResultValue->id;  ?>,'comment')" ><span>Comment</span></a>
                        ...
                        <div class="comm_des">
                            ...
                            <p class="comm_like">
                                ...
                                <span id="<?php echo $likeCountId; ?>"><?php echo getPinLikeCount($searchResultValue->id); ?> Likes</span>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <h2 style="padding-left:250px;">Sorry! No pin item found in this name</h2>
            <?php endif ?>
        </div> <!-- #alpha -->
